...
const tools = [
  {
    ...
    title: 'AI-värdering',
    description: 'Ladda upp ett konstverk och få en omedelbar prisuppskattning baserad på stil, teknik och marknadstrender.',
  ...
  },
  {
    ...
    title: 'Inspiration',
    description: 'Beskriv en känsla, ett tema eller en stil — och låt AI generera idéer, motiv och riktningar för ditt nästa verk.',
  ...
  return (
    <div className="space-y-10 max-w-3xl">
      ...
      <div className="space-y-3">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">AI-verktyg</h1>
        <p className="text-base text-slate-500 max-w-xl leading-relaxed">
          Kraftfulla verktyg som hjälper dig att värdera, utforska och skapa — direkt i plattformen.
        </p>
      </div>
