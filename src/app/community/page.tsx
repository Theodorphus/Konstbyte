  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="space-y-1">
        ...
        <h1 className="font-display text-3xl md:text-4xl text-slate-900">Community</h1>
        <p className="text-slate-500 text-sm">
          Dela din process, ge feedback och hitta inspiration — tillsammans.
        </p>
      </div>
      ...
      {currentUserEmail ? (
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 text-center space-y-2">
          <p className="text-sm font-medium text-amber-900">
            Logga in för att skriva inlägg och reagera
          </p>
          <a
      ...
      {error ? (
        <div className="rounded-2xl border border-red-100 bg-red-50/80 p-8 text-center space-y-3">
          <p className="font-medium text-red-700">Kunde inte ladda inlägg.</p>
          <button
            onClick={loadPosts}
        ...
        <div className="bg-white/90 rounded-2xl border border-slate-200/70 p-12 text-center space-y-3">
          ...
          <p className="font-semibold text-slate-700">Inga inlägg ännu</p>
          <p className="text-sm text-slate-400">Var den första att dela något med communityt.</p>
        </div>
      ) : (
        <div className="space-y-4">
          {posts.map((post) => (
