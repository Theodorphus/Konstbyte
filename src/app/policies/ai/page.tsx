...
export default function AIPolicyPage() {
  return (
    <PolicyLayout
      title="AI-policy"
      icon="🤖"
      subtitle="Konstbyte använder AI för att inspirera och vägleda — inte för att ersätta professionell bedömning. Här beskriver vi hur AI-verktygen fungerar och vad de får användas till."
