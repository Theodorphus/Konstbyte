...
export default function FAQPage() {
  return (
    <PolicyLayout
      ...
      icon="💬"
      subtitle="Hittar du inte svaret du letar efter? Kontakta oss på konstbyte@gmail.com så hjälper vi dig."
    >
      ...
      <div className="rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 p-6 text-center space-y-3">
        <p className="text-sm font-medium text-amber-900">Hittade du inte svaret?</p>
        <p className="text-sm text-amber-800">
          Vi svarar på alla frågor via e-post, vanligtvis inom 1–2 arbetsdagar.
        </p>
        <Link
